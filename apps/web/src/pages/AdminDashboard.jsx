      ...
      {error ? (
        <div className="card p-8 text-center mt-6">
          ...
          <button 
            ...
            className="mt-4 rounded-full border border-brand-black px-4 py-2 text-xs uppercase tracking-[0.3em] hover:bg-brand-black/5 transition-colors elevation-focus"
          >
            Retry
          </button>
        </div>
