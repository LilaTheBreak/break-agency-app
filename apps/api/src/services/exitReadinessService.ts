  ...
  try {
    ...
    return await prisma.exitReadinessScore.upsert({
      ...
      create: {
        ...
        overallScore,
        category,
        revenuePredicability: scores.revenuePredicability,
        founderIndependence: scores.founderIndependence,
        teamDepth: scores.teamDepth,
        ipOwnership: scores.ipOwnership,
        grossMargin: scores.grossMargin,
        platformRisk: scores.platformRisk,
        recurringRevenuePercent: scores.recurringRevenuePercent,
